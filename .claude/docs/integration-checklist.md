...
git merge origin/task-11-dynamodb --no-edit
git merge origin/task-12-lambda-scaffold --no-edit
git merge origin/task-13-iam-roles --no-edit
...
git push origin --delete task-11-dynamodb
git push origin --delete task-12-lambda-scaffold
git push origin --delete task-13-iam-roles
