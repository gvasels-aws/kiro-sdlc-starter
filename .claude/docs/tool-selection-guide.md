...
Prompt: "Write comprehensive unit tests for services/user-service/internal/handlers/handlers.go
...
"Do a comprehensive code review of the user service"
...
/test-file services/my-service/internal/handlers/handlers.go

# Run code review on a directory
/code-review services/my-service/
...
```
Spec → Test → Code → Build → Docs
  ↓      ↓      ↓       ↓      ↓
MCP   Agent  Agent   Bash   Agent
```
