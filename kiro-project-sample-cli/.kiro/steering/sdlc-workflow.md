...
### Interactive TDD with Claude Code
...
# Inside conversation:
> "Let's follow TDD for the user service"
> "First, write a failing test for creating a user"
> "Now implement just enough to make the test pass"
